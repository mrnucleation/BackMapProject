...
def main():
    formfact = {
            ...
            "He": 30,   #Actually Amide, but ASE returns Lammps type 2 as He
            "Li": 9,   #Actually CH3, but ASE returns Lammps type 3 as He
...
#            "Be": 1   #Actually H, but ASE returns Lammps type 4 as He
#            }
    filename = sys.argv[1]
